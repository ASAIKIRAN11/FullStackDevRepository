...
public class program3 {
		public static void main(String[] args) {
			SoftwareProduct obj1=new SoftwareProduct("Antivirus");
			SoftwareProduct obj2=new SoftwareProduct("Office Suite", 2023);
			SoftwareProduct obj3=new SoftwareProduct(299.99);
			SoftwareProduct obj4=new SoftwareProduct("Graphics Editor", 399.99, 2024, "XYZ-123-ABC", true);
			obj4.generateReport(); 
    }
}
